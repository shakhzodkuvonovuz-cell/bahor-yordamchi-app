# 📂 Bahor AI: Full Stack Discovery Document

> **Version:** January 30, 2026  
> **Project URL:** https://bahor-yordamchi-app.lovable.app  
> **Preview:** https://id-preview--96e8fdf8-d2d3-4c09-a124-fe6906fc902b.lovable.app
...
**Known Issues:**
- Strict file gating: If file extraction returns <200 chars, agent refuses to proceed
- Latency: Background execution can hit Edge Function timeouts on complex tasks
- Hallucination guards too strict: Sometimes blocks legitimate queries
...
| `premium` | 200 | ∞ | ∞ | ∞ | 49,000 UZS/month |
| `ultra` | 500 | ∞ | ∞ | ∞ | 340,000 UZS/year |
| `dev_unlimited` | ∞ | ∞ | ∞ | ∞ | Internal only |
...
```typescript
{
  ...
  plugins: {
    ...
    App: {},
    Haptics: {},
    Keyboard: { resize: 'body', scrollAssist: false }
  }
}
```
...
| `get-public-ip` | IP detection |
| `auth-send-email` | Auth emails |

---

## 9. Environment Variables

### Critical Secrets (Supabase)
...
| `ATMOS_CONSUMER_ID` | Payments |
| `ATMOS_CONSUMER_SECRET` | Payments |
| `ATMOS_STORE_ID` | Payments |
...
| `RUNPOD_ENDPOINT_ID` | Video endpoint |
| `GROQ_API_KEY` | Groq (backup) |
| `ILOVE_PUBLIC_KEY` | iLovePDF |
| `ILOVE_SECRET_KEY` | iLovePDF |
| `DEV_UNLIMITED_EMAILS` | Bypass emails |
| `ADMIN_EMAILS` | Admin access |

### Frontend Environment

```env
VITE_SUPABASE_URL=https://akqtmyvwylfejbgwcyll.supabase.co
VITE_SUPABASE_PUBLISHABLE_KEY=eyJ...
VITE_SUPABASE_PROJECT_ID=akqtmyvwylfejbgwcyll
```
