...
const TOOLS = {
  htmlpdf: { premium: false, freeDailyLimit: 5, premiumDailyLimit: 20 },
  imagepdf: { premium: false, freeDailyLimit: 5, premiumDailyLimit: 20 },
  merge: { premium: false, freeDailyLimit: 5, premiumDailyLimit: 20 },
  split: { premium: false, freeDailyLimit: 5, premiumDailyLimit: 20 },
  compress: { premium: false, freeDailyLimit: 5, premiumDailyLimit: 20 },
  watermark: { premium: false, freeDailyLimit: 5, premiumDailyLimit: 20 },
  pagenumber: { premium: false, freeDailyLimit: 5, premiumDailyLimit: 20 },
  ocr: { premium: true, freeDailyLimit: 0, premiumDailyLimit: 2, maxPages: 10 },
  officepdf: { premium: false, freeDailyLimit: 5, premiumDailyLimit: 20 },
  pdfjpg: { premium: false, freeDailyLimit: 5, premiumDailyLimit: 20 },
  rotate: { premium: false, freeDailyLimit: 5, premiumDailyLimit: 20 },
