  ...
  return (
    <div className="h-dvh w-full max-w-full bg-background flex flex-col overflow-hidden" style={{ maxWidth: '100vw', overflowX: 'hidden' }}>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col min-h-0 overflow-hidden">
        ...
        <div className="flex-shrink-0 z-50 border-b border-border bg-background/95 backdrop-blur-md overflow-x-hidden" style={{ position: 'sticky', top: 0 }}>
          <TabsList className="max-w-2xl mx-auto w-full justify-start px-4 bg-transparent h-11 flex-nowrap">
            <TabsTrigger 
              value="chat" 
