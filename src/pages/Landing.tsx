...
function HeroMockup() {
  ...
  return (
    <div className="relative w-full max-w-md mx-auto">
        ...
        <div className="p-4 space-y-3">
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] text-muted-foreground">3 ta manba topildi</span>
            </div>
            <div className="flex gap-1.5 flex-wrap">
              <span className="text-[10px] px-2 py-1 rounded-full bg-primary/10 text-primary border border-primary/20 flex items-center gap-1">
                <ExternalLink className="w-2.5 h-2.5" />kun.uz
              </span>
              <span className="text-[10px] px-2 py-1 rounded-full bg-primary/10 text-primary border border-primary/20 flex items-center gap-1">
          ...
          {/* AI response */}
          <div className="space-y-2">
            <p className="text-sm font-medium text-foreground">{t('mockup.aiMessage')}</p>
            <p className="text-xs text-muted-foreground leading-relaxed">
              2024-yilda qabul qilingan yangi qonun asosida mehnat shartnomalari elektron tarzda rasmiylashtirilishi mumkin [1].
            </p>
      ...
      {/* Floating image gen - positioned cleanly to the right */}
      <div className="absolute -right-4 top-24 w-20 h-20 rounded-xl bg-card border border-border/40 shadow-xl flex flex-col items-center justify-center hover:scale-105 transition-transform">
        <ImagePlus className="w-6 h-6 text-primary mb-1" />
        <span className="text-[9px] text-muted-foreground font-medium">AI Rasm</span>
        <span className="text-[8px] text-primary/80">yaratish</span>
      </div>
    </div>
  );
}
