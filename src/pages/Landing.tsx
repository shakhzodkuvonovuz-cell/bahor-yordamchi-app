...
// Hero mockup with realistic chat UI matching actual app
function HeroMockup() {
  ...
  return (
    <div className="relative w-full max-w-lg mx-auto">
      ...
      {/* Main card - bigger and more detailed */}
      <div className="relative glass-premium rounded-2xl shadow-glow-lg animate-float-slow border border-border/40 overflow-hidden">
        {/* Header bar - like real chat */}
        <div className="flex items-center justify-between px-4 py-3 border-b border-border/30 bg-card/50">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-xl bg-primary/20 flex items-center justify-center hover:bg-primary/30 transition-colors cursor-pointer">
          ...
          <div className="flex items-center gap-1 bg-secondary/60 rounded-lg p-0.5">
            ...
            <span className="text-[10px] px-2 py-1 rounded-md text-muted-foreground hover:text-foreground transition-colors cursor-pointer">Aqlli</span>
          </div>
        </div>
        
        {/* Messages area */}
        <div className="p-4 space-y-4 max-h-[320px] overflow-hidden">
          {/* User message with avatar */}
          <div className="flex justify-end gap-2">
            <div className="bg-primary/10 border border-primary/20 text-foreground px-4 py-2.5 rounded-2xl rounded-tr-sm max-w-[85%] hover:bg-primary/15 transition-colors">
              <p className="text-sm">{t('mockup.userMessage')}</p>
            </div>
          </div>
          
          {/* ThinkBar mockup - shows AI processing */}
          <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-secondary/40 border border-border/30 max-w-[200px]">
            <Sparkles className="w-3.5 h-3.5 text-primary animate-pulse" />
            <span className="text-xs text-muted-foreground">Web qidirilmoqda...</span>
            <div className="flex items-center gap-0.5 ml-auto">
              <span className="w-1 h-1 rounded-full bg-primary/60 animate-[pulse_1.4s_ease-in-out_infinite]" />
              <span className="w-1 h-1 rounded-full bg-primary/60 animate-[pulse_1.4s_ease-in-out_0.2s_infinite]" />
              <span className="w-1 h-1 rounded-full bg-primary/60 animate-[pulse_1.4s_ease-in-out_0.4s_infinite]" />
            </div>
          </div>
          
          {/* AI response - detailed with sources */}
          <div className="space-y-2">
            {/* Sources header */}
            <div className="flex items-center gap-2">
              <Search className="w-3 h-3 text-primary" />
              <span className="text-[10px] text-muted-foreground font-medium">3 ta manba topildi</span>
            </div>
            
            {/* Source chips - clickable style */}
            <div className="flex gap-1.5 flex-wrap mb-2">
              <span className="text-[10px] px-2.5 py-1 rounded-full bg-primary/10 text-primary border border-primary/20 flex items-center gap-1 hover:bg-primary/20 transition-colors cursor-pointer">
            ...
            <div className="text-sm text-foreground leading-relaxed">
              <p className="mb-2">{t('mockup.aiMessage')}</p>
              <p className="text-muted-foreground text-xs">2024-yilda qabul qilingan yangi qonun asosida mehnat shartnomalari elektron tarzda rasmiylashtirilishi mumkin [1].</p>
            </div>
          ...
          <div className="flex gap-2 flex-wrap">
            <button className="text-[10px] px-3 py-1.5 rounded-full bg-secondary/50 border border-border/40 text-muted-foreground hover:bg-secondary hover:text-foreground transition-all hover:scale-[1.02]">
              Batafsil tushuntiring
            </button>
            <button className="text-[10px] px-3 py-1.5 rounded-full bg-secondary/50 border border-border/40 text-muted-foreground hover:bg-secondary hover:text-foreground transition-all hover:scale-[1.02]">
              Qonun matnini ko'rsating
            </button>
          </div>
        </div>
        
        {/* Input area - realistic */}
        <div className="px-4 py-3 border-t border-border/30 bg-card/30">
          <div className="flex items-center gap-2">
            ...
            {/* Input field */}
            <div className="flex-1 flex items-center gap-2 bg-secondary/40 rounded-xl px-4 py-2.5 border border-border/30">
            ...
            <button className="w-9 h-9 rounded-xl bg-primary flex items-center justify-center hover:bg-primary/90 transition-colors shadow-lg shadow-primary/20">
      ...
      {/* Floating image gen preview */}
      <div className="absolute -right-3 top-1/3 w-28 h-28 rounded-xl bg-gradient-to-br from-card to-card/80 border border-border/40 shadow-xl flex flex-col items-center justify-center overflow-hidden hover:scale-105 transition-transform cursor-pointer">
        <div className="absolute inset-0 bg-gradient-to-br from-primary/10 to-transparent" />
        <ImagePlus className="w-7 h-7 text-primary mb-1 relative z-10" />
        <span className="text-[10px] text-muted-foreground font-medium relative z-10">AI Rasm</span>
        <span className="text-[8px] text-primary/70 relative z-10">yaratish</span>
      </div>
      
      {/* Floating file attachment preview */}
      <div className="absolute -left-2 bottom-20 w-24 h-16 rounded-lg bg-card border border-border/40 shadow-lg flex items-center gap-2 px-2 hover:scale-105 transition-transform cursor-pointer">
        <div className="w-8 h-8 rounded-lg bg-red-500/20 flex items-center justify-center">
          <FileText className="w-4 h-4 text-red-500" />
        </div>
        <div className="flex-1 min-w-0">
          <p className="text-[9px] font-medium text-foreground truncate">shartnoma.pdf</p>
          <p className="text-[8px] text-muted-foreground">2.4 MB</p>
        </div>
      </div>
    </div>
  );
